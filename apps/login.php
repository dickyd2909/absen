...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="assets/fontawesome/fontawesome.css" rel="stylesheet" type="text/css" />
		<link href="assets/fontawesome/fontawesome.min.css" rel="stylesheet" type="text/css" />
			...
			<div id="bocontainer">
				<div id="container">
					...
					<form action="/loginaction" method="post">
						<input type="text" name="username" class="loginform" placeholder="Username / NISN" required><!--onkeypress="return hanyaAngka(event)"--></input>
						<div class="iconeye">
							<input type="password" name="password"  class="loginform" placeholder="Password" required  id="id_password"><i class="far fa-eye" id="togglePassword" onclick="showPassword()"></i>
						</div>	
